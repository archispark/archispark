...
1. **Check coverage**: `pnpm run -w test:coverage` — line/branch/function coverage must stay at or above **80%**. If a change drops coverage below 80%, add tests before finishing.
