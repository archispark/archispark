...
1. **When tagging a release** (e.g. `git tag 0.4.0`), bump `package.json` `"version"` to match, run `npm test`, commit the bump, then create the tag and push both: `git push origin main --tags`.
