...
Next.js front-end for ArchiSpark Admin, an open-source ArchiMate 3.1 modeling tool.

Interactive canvas for creating and editing ArchiMate diagrams. Connects to the ArchiSpark API.
