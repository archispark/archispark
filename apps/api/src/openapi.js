...
export const openApiSpec = {
    ...
    info: {
        title: "mcp-archimate",
        version,
        description: "API REST pour interroger et modifier un modèle ArchiMate 3.1 au format Open Exchange File (.xml). " +
    ...
    paths: {
        ...
        "/mcp/": {
            post: {
                ...
                operationId: "mcpPost",
                description: "Point d'entrée JSON-RPC 2.0 du transport streamable-http MCP. " +
