...
describe("PlatformAdminBlock", () => {
  ...
  it("renders the title, description and logout button using real i18n translations", () => {
    ...
    expect(
      screen.getByText(
        "Les comptes Admin gèrent les organisations depuis l'interface d'administration. Entrez dans une organisation depuis cette interface pour travailler dans ses espaces de travail avec un accès complet.",
      ),
    ).toBeInTheDocument();
