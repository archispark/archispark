/**
 * Deterministic fake "access tokens" for the api test suite.
 *
...
// Fixed demo user subs for deterministic test fixtures — defined locally
...
export async function fakeVerifyAccessToken(
  token: string
